    ...
    with st.form("patient_data_form"):
        ...
        with col1:
            ...
            if apparatus == "BjoEMG II":
                ...
                st.caption("⚠️ Патология: жевательная максимальная ≥ 278 мкВ (средняя ≥ 111 мкВ); височная максимальная ≥ 558 мкВ (средняя ≥ 138 мкВ)")
            else:
            ...
            if apparatus == "BjoEMG II":
                ...
                help_masseter_r = "Патология: максимальная ≥ 278 мкВ, средняя ≥ 111 мкВ"
                help_masseter_l = "Патология: максимальная ≥ 278 мкВ, средняя ≥ 111 мкВ"
                help_temporalis_r = "Патология: максимальная ≥ 558 мкВ, средняя ≥ 138 мкВ"
                help_temporalis_l = "Патология: максимальная ≥ 558 мкВ, средняя ≥ 138 мкВ"
            else:
