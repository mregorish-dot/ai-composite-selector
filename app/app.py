            ...
            if wear_severity_type == "TWES 2.0 (современная)":
                ...
                with col_wear1:
                    wear_severity = st.selectbox(
                        ...
                        key="wear_severity_twes"  # Уникальный ключ для правильного обновления
                    )
                with col_wear2:
                    # Правка 3: Добавлены показатели справа
                    if wear_severity != "Не указана":
                        # Правка 3: Показатели справа согласно классификации
                        # Правка 3: Показатели справа согласно требованиям
                        twes_descriptions = {
                ...
                with col_wear1:
                    wear_severity = st.selectbox(
                        ...
                        key="wear_severity_bushan"  # Уникальный ключ для правильного обновления
                    )
                with col_wear2:
                    # Правка 3: Добавлены показатели справа
                    if wear_severity != "Не указана":
                        # Правка 3: Показатели справа согласно классификации Бушан М.Г.
                        bush_descriptions = {
